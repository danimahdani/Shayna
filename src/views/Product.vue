                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :autoplay="true" :nav="false" :dots="false" >
                                    <div class="pt mr-2" :class="{active: gambar_default == thumbs[0]}"  @click="changeImage(thumbs[0])">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt mr-2" :class="{active: gambar_default == thumbs[1]}" @click="changeImage(thumbs[1])">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt mr-2" :class="{active: gambar_default == thumbs[2]}"  @click="changeImage(thumbs[2])">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt mr-2" :class="{active: gambar_default == thumbs[3]}"  @click="changeImage(thumbs[3])">
